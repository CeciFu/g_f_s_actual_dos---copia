...
<div class="divTitulo">
  <h1>&nbsp;</h1>
  <h1>Reporte: Documentos ingresador por a&ntilde;o al archivo hist&oacute;rico</h1>
<?php  
  $tipo = $_SESSION['tipo'];
...
<!------Busquedas----------------------------------------------------------------------------------->	 
<form action="archivoPorAnio.php" method="post"  name="form2" id="form2">
<p >&nbsp;</p>
...
<table width="690" class="tabla">
      <tr>
        <td colspan="2"><div class="ayuda">Seleccione a&ntilde;o para conocer los expedientes que fueron ingresados al archivo</div></td>
      </tr>
	  <tr>
	  <td > 
		<p> A&ntilde;o </p></td>
